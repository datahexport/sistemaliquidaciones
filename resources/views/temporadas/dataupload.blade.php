              ...
              <main>
               ...
               <div class="py-16 bg-gray-50 overflow-hidden">
                  <div class="container m-auto px-6 space-y-8 text-gray-500 md:px-12">
                      <div>
                          <span class="text-gray-600 text-lg font-semibold">Data Load</span>
                          <h2 class="mt-4 text-2xl text-gray-900 font-bold md:text-4xl">Carga de Base de Datos al Sistema de Liquidaciones</h2>
                      </div>
