<x-app-layout>
    ...
    <div class="pb-8 pt-2">
        ...
        <div class="card">
            @if ($fob->count()>0)
                @livewire('temporada-show', ['temporada' => $temporada, 'vista' => 'FOBNACIONAL'], key($temporada->id))
            ...
            @else
                ...
                <div class="flex w-full bg-gray-300" x-data="{openMenu:1}">
                    ...
                    @livewire('main-upload', ['temporada' => $temporada,'vista'=>'fobnacional'], key($temporada->id))
