                                ...
                                @endif
                                    ...
                                    <div class="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50 z-50" x-show="upvariable">
                                        <div class="relative flex flex-col items-center rounded-[20px] w-[700px] max-w-[95%] mx-auto bg-white bg-clip-border shadow-3xl shadow-lg dark:!bg-navy-800 dark:text-white dark:!shadow-none p-3">
                                            ...
                                            <div class="">
                                                <form action="{{route('temporada.importBalance4')}}" method="POST" class="bg-white rounded px-8 shadow my-4" enctype="multipart/form-data">
                                                    @csrf
                                            ...
                                            <div class="grid grid-cols-2 gap-4 px-2 w-full">
                                                ...
                                                <div class="flex flex-col justify-center rounded-2xl bg-white bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
                                                    <p class="text-sm text-gray-600">Folios:</p>
                                                    <p class="text-base font-medium text-navy-700 dark:text-white">
                                                        {{$unique_folios->count()}}
                                                    </p>
                                                </div>
                                    ...
                                    <div class="flex justify-end mt-2">
                                        <button x-on:click="upvariable=true" class="ml-2 focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 text-sm leading-none text-gray-600 py-3 px-5 bg-gray-500 rounded hover:bg-gray-600 focus:outline-none">
                                            <h1 style="font-size: 1rem;white-space: nowrap;" class="text-center text-white font-bold inline w-full" >
                                                Subir Base Detalle Liquidación
                                            </h1>
                                        </button>
                                    </div>
                                   
                                <div class="z-10 w-full">
                                    @livewire('liquidacion-search', ['temporada' => $temporada], key($temporada->id))
                                </div>
                            </div>
