                    ...
                    <div class="py-8">
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-4">
                            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg" x-data="{upvariable:false}">
                                        ...
                                        <div class="relative flex flex-col items-center rounded-[20px] w-[700px] max-w-[95%] mx-auto bg-white bg-clip-border shadow-3xl shadow-lg dark:!bg-navy-800 dark:text-white dark:!shadow-none p-3">
                                            <div class="mt-2 mb-2 w-full">
                                                <div class="flex justify-between w-full ">
                                                    <h4 class="px-2 text-xl font-bold text-navy-700 dark:text-white">Base Venta Comercial</h4>
                                            ...
                                            <div>
                                                <form action="{{route('temporada.importVentacomercial')}}" method="POST" class="bg-white rounded px-8 shadow my-4" enctype="multipart/form-data">
                                                    @csrf
                                    ...
                                    @livewire('ventacomercial-search', ['temporada' => $temporada], key($temporada->id))
                ...
                @else
                    <div class="flex flex-col justify-center items-center h-[100vh]">
                        ...
                        <div class="relative flex flex-col items-center rounded-[20px] w-[700px] max-w-[95%] mx-auto bg-white bg-clip-border shadow-3xl shadow-lg  dark:!bg-navy-800 dark:text-white dark:!shadow-none p-3">
                            ...
                            <div class="">
                                <form action="{{route('temporada.importVentacomercial')}}"
                                    method="POST"
