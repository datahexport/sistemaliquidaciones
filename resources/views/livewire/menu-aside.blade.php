            ...
            wire:navigate>
              ...
              wire:navigate>
                <div class="p-2 flex flex-col items-center bg-white rounded-md justify-center shadow-xl cursor-pointer">
                  ...
                  <p class="text-xs mt-1 text-center font-semibold">Fob<br>Exportacón</p>
                </div>
              </a>

              <a href="{{route('temporada.fobnacional',$temporada)}}"
              wire:navigate>
                <div class="p-2 flex flex-col items-center bg-white rounded-md justify-center shadow-xl cursor-pointer">
                  <div class="rounded-full p-2 @if($temporada->fobnacionals->count()>0)bg-green-200 @else bg-indigo-200 @endif flex flex-col items-center">
                    <i class="fas fa-shopping-basket fa-sm @if($temporada->fobnacionals->count()>0)text-green-600 @else text-indigo-600 @endif"></i>
                  </div>
                  <p class="text-xs mt-1 text-center font-semibold">Fob<br>Nacional</p>
                </div>
              </a>
