       ...
       <div class="flex-1 px-3 bg-white divide-y space-y-1">
        <div class="block px-4 py-2 text-xs text-gray-400">
          ...
          <div class="space-y-2 pt-2">
            ...
            @if (Route::currentRouteName() == 'temporada.dataupload' || Route::currentRouteName() == 'temporada.datauploadliq' || Route::currentRouteName() == 'temporada.datauploaddesp' || Route::currentRouteName() == 'temporada.datauploaddet' || Route::currentRouteName() == 'temporada.datauploadprod')
